...
void main() {
  ...
  group('conversions', () {
    ...
    // assertInvalid('invalid conversions.1.wasm', 'conversions/conversions.1.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.2.wasm', 'conversions/conversions.2.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.3.wasm', 'conversions/conversions.3.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.4.wasm', 'conversions/conversions.4.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.5.wasm', 'conversions/conversions.5.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.6.wasm', 'conversions/conversions.6.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.7.wasm', 'conversions/conversions.7.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.8.wasm', 'conversions/conversions.8.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.9.wasm', 'conversions/conversions.9.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.10.wasm', 'conversions/conversions.10.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.11.wasm', 'conversions/conversions.11.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.12.wasm', 'conversions/conversions.12.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.13.wasm', 'conversions/conversions.13.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.14.wasm', 'conversions/conversions.14.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.15.wasm', 'conversions/conversions.15.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.16.wasm', 'conversions/conversions.16.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.17.wasm', 'conversions/conversions.17.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.18.wasm', 'conversions/conversions.18.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.19.wasm', 'conversions/conversions.19.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.20.wasm', 'conversions/conversions.20.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.21.wasm', 'conversions/conversions.21.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.22.wasm', 'conversions/conversions.22.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.23.wasm', 'conversions/conversions.23.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.24.wasm', 'conversions/conversions.24.wasm', 'type mismatch', registered);
    // assertInvalid('invalid conversions.25.wasm', 'conversions/conversions.25.wasm', 'type mismatch', registered);
  });
}
