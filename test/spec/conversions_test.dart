...
void main() {
  ...
  group('conversions.0.wasm', () {
    ...
    returns(
        'i64_extend_i32_s_1', () => m.$('i64.extend_i32_s', [0x2710]), 0x2710);
    returns(
        'i64_extend_i32_s_2',
    ...
    returns(
        'i64_extend_i32_u_1', () => m.$('i64.extend_i32_u', [0x2710]), 0x2710);
    ...
    returns('i32_trunc_f32_s_0', () => m.$('i32.trunc_f32_s', [$f32('0')]), 0);
    returns('i32_trunc_f32_s_1',
        () => m.$('i32.trunc_f32_s', [$f32('80000000')]), 0);
    returns('i32_trunc_f32_s_2', () => m.$('i32.trunc_f32_s', [$f32('1')]), 0);
    ...
    traps(
        ...
        'invalid conversion to integer');
    returns('i32_trunc_f32_u_0', () => m.$('i32.trunc_f32_u', [$f32('0')]), 0);
    returns('i32_trunc_f32_u_1',
        () => m.$('i32.trunc_f32_u', [$f32('80000000')]), 0);
    returns('i32_trunc_f32_u_2', () => m.$('i32.trunc_f32_u', [$f32('1')]), 0);
    ...
    traps(
        ...
        'invalid conversion to integer');
    returns('i32_trunc_f64_s_0', () => m.$('i32.trunc_f64_s', [$f64('0')]), 0);
    returns('i32_trunc_f64_s_1',
        () => m.$('i32.trunc_f64_s', [$f64('8000000000000000')]), 0);
    returns('i32_trunc_f64_s_2', () => m.$('i32.trunc_f64_s', [$f64('1')]), 0);
    ...
    traps(
        ...
        'invalid conversion to integer');
    returns('i32_trunc_f64_u_0', () => m.$('i32.trunc_f64_u', [$f64('0')]), 0);
    returns('i32_trunc_f64_u_1',
        () => m.$('i32.trunc_f64_u', [$f64('8000000000000000')]), 0);
    returns('i32_trunc_f64_u_2', () => m.$('i32.trunc_f64_u', [$f64('1')]), 0);
    ...
    traps(
        ...
        'invalid conversion to integer');
    returns('i64_trunc_f32_s_0', () => m.$('i64.trunc_f32_s', [$f32('0')]), 0);
    returns('i64_trunc_f32_s_1',
        () => m.$('i64.trunc_f32_s', [$f32('80000000')]), 0);
    returns('i64_trunc_f32_s_2', () => m.$('i64.trunc_f32_s', [$f32('1')]), 0);
    ...
    traps(
        ...
        'invalid conversion to integer');
    returns('i64_trunc_f32_u_0', () => m.$('i64.trunc_f32_u', [$f32('0')]), 0);
    returns('i64_trunc_f32_u_1',
        () => m.$('i64.trunc_f32_u', [$f32('80000000')]), 0);
    returns('i64_trunc_f32_u_2', () => m.$('i64.trunc_f32_u', [$f32('1')]), 0);
    ...
    traps(
        ...
        'invalid conversion to integer');
    returns('i64_trunc_f64_s_0', () => m.$('i64.trunc_f64_s', [$f64('0')]), 0);
    returns('i64_trunc_f64_s_1',
        () => m.$('i64.trunc_f64_s', [$f64('8000000000000000')]), 0);
    returns('i64_trunc_f64_s_2', () => m.$('i64.trunc_f64_s', [$f64('1')]), 0);
    ...
    traps(
        ...
        'invalid conversion to integer');
    returns('i64_trunc_f64_u_0', () => m.$('i64.trunc_f64_u', [$f64('0')]), 0);
    returns('i64_trunc_f64_u_1',
        () => m.$('i64.trunc_f64_u', [$f64('8000000000000000')]), 0);
    returns('i64_trunc_f64_u_2', () => m.$('i64.trunc_f64_u', [$f64('1')]), 0);
    ...
    returns(
        'f32_convert_i32_s_2', () => m.$('f32.convert_i32_s', [0]), $f32('0'));
    ...
    returns(
        ...
        $f32('BF800000'));
    returns(
        'f32_convert_i64_s_2', () => m.$('f32.convert_i64_s', [0]), $f32('0'));
    returns(
        'f32_convert_i64_s_3',
    ...
    returns(
        'f64_convert_i32_s_2', () => m.$('f64.convert_i32_s', [0]), $f64('0'));
    returns(
        'f64_convert_i32_s_3',
    ...
    returns(
        ...
        $f64('BFF0000000000000'));
    returns(
        'f64_convert_i64_s_2', () => m.$('f64.convert_i64_s', [0]), $f64('0'));
    returns(
        'f64_convert_i64_s_3',
    ...
    returns('f32_convert_i32_u_0', () => m.$('f32.convert_i32_u', [1]),
        $f32('3F800000'));
    returns(
        'f32_convert_i32_u_1', () => m.$('f32.convert_i32_u', [0]), $f32('0'));
    ...
    returns('f32_convert_i64_u_0', () => m.$('f32.convert_i64_u', [1]),
        $f32('3F800000'));
    returns(
        'f32_convert_i64_u_1', () => m.$('f32.convert_i64_u', [0]), $f32('0'));
    returns(
        'f32_convert_i64_u_2',
    ...
    returns('f64_convert_i32_u_0', () => m.$('f64.convert_i32_u', [1]),
        $f64('3FF0000000000000'));
    returns(
        'f64_convert_i32_u_1', () => m.$('f64.convert_i32_u', [0]), $f64('0'));
    returns(
        'f64_convert_i32_u_2',
    ...
    returns('f64_convert_i64_u_0', () => m.$('f64.convert_i64_u', [1]),
        $f64('3FF0000000000000'));
    returns(
        'f64_convert_i64_u_1', () => m.$('f64.convert_i64_u', [0]), $f64('0'));
    returns(
        'f64_convert_i64_u_2',
    ...
    returns('f32_reinterpret_i32_0', () => m.$('f32.reinterpret_i32', [0]),
        $f32('0'));
    returns('f32_reinterpret_i32_1',
        () => m.$('f32.reinterpret_i32', [$i32('80000000')]), $f32('80000000'));
    returns('f32_reinterpret_i32_2', () => m.$('f32.reinterpret_i32', [1]),
        $f32('1'));
    returns('f32_reinterpret_i32_3',
        () => m.$('f32.reinterpret_i32', [$i32('FFFFFFFF')]), $f32('FFFFFFFF'));
    returns('f32_reinterpret_i32_4',
        () => m.$('f32.reinterpret_i32', [$i32('75BCD15')]), $f32('75BCD15'));
    returns('f32_reinterpret_i32_5',
        () => m.$('f32.reinterpret_i32', [$i32('80000001')]), $f32('80000001'));
    returns('f32_reinterpret_i32_6',
        () => m.$('f32.reinterpret_i32', [$i32('7F800000')]), $f32('7F800000'));
    returns('f32_reinterpret_i32_7',
        () => m.$('f32.reinterpret_i32', [$i32('FF800000')]), $f32('FF800000'));
    returns('f32_reinterpret_i32_8',
        () => m.$('f32.reinterpret_i32', [$i32('7FC00000')]), $f32('7FC00000'));
    returns('f32_reinterpret_i32_9',
        () => m.$('f32.reinterpret_i32', [$i32('FFC00000')]), $f32('FFC00000'));
    returns('f32_reinterpret_i32_10',
        () => m.$('f32.reinterpret_i32', [$i32('7FA00000')]), $f32('7FA00000'));
    returns('f32_reinterpret_i32_11',
        () => m.$('f32.reinterpret_i32', [$i32('FFA00000')]), $f32('FFA00000'));
    ...
    returns(
        ...
        $f64('8000000000000000'));
    returns('f64_reinterpret_i64_4',
        () => m.$('f64.reinterpret_i64', [$i64('499602D2')]), $f64('499602D2'));
    returns(
    ...
    returns('i32_reinterpret_f32_6',
        () => m.$('i32.reinterpret_f32', [$f32('40490FDA')]), $i32('40490FDA'));
    returns('i32_reinterpret_f32_7',
        () => m.$('i32.reinterpret_f32', [$f32('7F7FFFFF')]), $i32('7F7FFFFF'));
    returns(
