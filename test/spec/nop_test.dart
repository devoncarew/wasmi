...
void main() {
  ...
  group('nop', () {
    group('nop.0.wasm', () {
      ...
      returns(
          'as_drop_first_0', () => m.$('as-drop-first', [0]), null /*void*/);
      ...
      returns(
          'as_br_if_everywhere_0', () => m.$('as-br_if-everywhere', [7]), 7);
      ...
      returns('as_call_everywhere_0',
          () => m.$('as-call-everywhere', [2, 1, 5]), $i32('FFFFFFFE'));
      ...
      returns('as_compare_everywhere_0',
          () => m.$('as-compare-everywhere', [3]), 1);
      returns(
          'as_memory_grow_first_0', () => m.$('as-memory.grow-first', [0]), 1);
      returns(
          'as_memory_grow_last_0', () => m.$('as-memory.grow-last', [2]), 1);
      ...
      returns(
          'as_load_everywhere_0', () => m.$('as-load-everywhere', [0x64]), 0);
      returns('as_store_first_0', () => m.$('as-store-first', [0, 1]),
          null /*void*/);
      returns(
          'as_store_mid_0', () => m.$('as-store-mid', [0, 2]), null /*void*/);
      returns(
