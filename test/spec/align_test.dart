...
void main() {
  ...
  group('align.106.wasm', () {
    ...
    returns('i32_align_switch_10', () => m.$('i32_align_switch', [4, 0]), 0xA);
    returns('i32_align_switch_11', () => m.$('i32_align_switch', [4, 1]), 0xA);
    returns('i32_align_switch_12', () => m.$('i32_align_switch', [4, 2]), 0xA);
    returns('i32_align_switch_13', () => m.$('i32_align_switch', [4, 4]), 0xA);
    ...
    returns('i64_align_switch_10', () => m.$('i64_align_switch', [4, 0]), 0xA);
    returns('i64_align_switch_11', () => m.$('i64_align_switch', [4, 1]), 0xA);
    returns('i64_align_switch_12', () => m.$('i64_align_switch', [4, 2]), 0xA);
    returns('i64_align_switch_13', () => m.$('i64_align_switch', [4, 4]), 0xA);
    returns('i64_align_switch_14', () => m.$('i64_align_switch', [5, 0]), 0xA);
    returns('i64_align_switch_15', () => m.$('i64_align_switch', [5, 1]), 0xA);
    returns('i64_align_switch_16', () => m.$('i64_align_switch', [5, 2]), 0xA);
    returns('i64_align_switch_17', () => m.$('i64_align_switch', [5, 4]), 0xA);
    returns('i64_align_switch_18', () => m.$('i64_align_switch', [6, 0]), 0xA);
    returns('i64_align_switch_19', () => m.$('i64_align_switch', [6, 1]), 0xA);
    returns('i64_align_switch_20', () => m.$('i64_align_switch', [6, 2]), 0xA);
    returns('i64_align_switch_21', () => m.$('i64_align_switch', [6, 4]), 0xA);
    returns('i64_align_switch_22', () => m.$('i64_align_switch', [6, 8]), 0xA);
  });
