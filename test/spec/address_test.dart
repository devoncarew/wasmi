  ...
  group('address', () {
    group('address.0.wasm', () {
      ...
      traps('32_good3_4', () => m.$('32_good3', [$i32('FFFFFFFF')]),
          'out of bounds memory access');
      traps(
          '8u_bad_0', () => m.$('8u_bad', [0]), 'out of bounds memory access');
      traps(
          '8s_bad_0', () => m.$('8s_bad', [0]), 'out of bounds memory access');
      traps('16u_bad_0', () => m.$('16u_bad', [0]),
          'out of bounds memory access');
      traps('16s_bad_0', () => m.$('16s_bad', [0]),
          'out of bounds memory access');
      traps(
          '32_bad_0', () => m.$('32_bad', [0]), 'out of bounds memory access');
      traps(
          '8u_bad_1', () => m.$('8u_bad', [1]), 'out of bounds memory access');
      traps(
          '8s_bad_1', () => m.$('8s_bad', [1]), 'out of bounds memory access');
      traps('16u_bad_1', () => m.$('16u_bad', [1]),
          'out of bounds memory access');
      traps('16s_bad_1', () => m.$('16s_bad', [1]),
          'out of bounds memory access');
      traps(
          '32_bad_1', () => m.$('32_bad', [1]), 'out of bounds memory access');
    });
    ...
    group('address.2.wasm', () {
      ...
      returns(
          '64_good1_0', () => m.$('64_good1', [0]), $i64('6867666564636261'));
      returns(
          '64_good2_0', () => m.$('64_good2', [0]), $i64('6867666564636261'));
      returns(
          '64_good3_0', () => m.$('64_good3', [0]), $i64('6968676665646362'));
      returns(
          '64_good4_0', () => m.$('64_good4', [0]), $i64('6A69686766656463'));
      ...
      traps('16s_bad_0', () => m.$('16s_bad', [0]),
          'out of bounds memory access');
      traps('32u_bad_0', () => m.$('32u_bad', [0]),
          'out of bounds memory access');
      traps('32s_bad_0', () => m.$('32s_bad', [0]),
          'out of bounds memory access');
      traps(
          '64_bad_0', () => m.$('64_bad', [0]), 'out of bounds memory access');
      traps(
          '8u_bad_1', () => m.$('8u_bad', [1]), 'out of bounds memory access');
      traps(
          '8s_bad_1', () => m.$('8s_bad', [1]), 'out of bounds memory access');
      ...
      traps('16s_bad_1', () => m.$('16s_bad', [1]),
          'out of bounds memory access');
      traps('32u_bad_1', () => m.$('32u_bad', [0]),
          'out of bounds memory access');
      traps('32s_bad_1', () => m.$('32s_bad', [0]),
          'out of bounds memory access');
      traps(
          '64_bad_1', () => m.$('64_bad', [1]), 'out of bounds memory access');
    });
    ...
    group('address.4.wasm', () {
      ...
      returns(
          '64_good5_0', () => m.$('64_good5', [0]), $f64('7FFC000000000001'));
