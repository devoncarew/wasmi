...
void main() {
  ...
  group('select', () {
    group('select.0.wasm', () {
      ...
      returns(
          ...
          () => m.$('select-f64-t',
              [$f64('3FF0000000000000'), $f64('4000000000000000'), 1]),
          $f64('3FF0000000000000'));
      returns('select_funcref_0', () => m.$('select-funcref', [null, null, 1]),
          null);
      returns(
          'select_externref_0',
      ...
      returns('as_if_condition_0', () => m.$('as-if-condition', [0]),
          null /*void*/);
      returns('as_if_condition_1', () => m.$('as-if-condition', [1]),
          null /*void*/);
      ...
      returns(
          'as_store_last_0', () => m.$('as-store-last', [0]), null /*void*/);
      returns(
          'as_store_last_1', () => m.$('as-store-last', [1]), null /*void*/);
      returns(
      ...
      returns('as_drop_operand_0', () => m.$('as-drop-operand', [0]),
          null /*void*/);
      returns('as_drop_operand_1', () => m.$('as-drop-operand', [1]),
          null /*void*/);
      ...
      returns(
          'as_global_set_value_0', () => m.$('as-global.set-value', [0]), 2);
      returns(
    ...
    // assertInvalid('invalid select.1.wasm', 'select/select.1.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.2.wasm', 'select/select.2.wasm', 'invalid result arity', registered);
    // assertInvalid('invalid select.3.wasm', 'select/select.3.wasm', 'invalid result arity', registered);
    // assertInvalid('invalid select.4.wasm', 'select/select.4.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.5.wasm', 'select/select.5.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.6.wasm', 'select/select.6.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.7.wasm', 'select/select.7.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.8.wasm', 'select/select.8.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.9.wasm', 'select/select.9.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.10.wasm', 'select/select.10.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.11.wasm', 'select/select.11.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.12.wasm', 'select/select.12.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.13.wasm', 'select/select.13.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.14.wasm', 'select/select.14.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.15.wasm', 'select/select.15.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.16.wasm', 'select/select.16.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.17.wasm', 'select/select.17.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.18.wasm', 'select/select.18.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.19.wasm', 'select/select.19.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.20.wasm', 'select/select.20.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.21.wasm', 'select/select.21.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.22.wasm', 'select/select.22.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.23.wasm', 'select/select.23.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.24.wasm', 'select/select.24.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.25.wasm', 'select/select.25.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.26.wasm', 'select/select.26.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.27.wasm', 'select/select.27.wasm', 'type mismatch', registered);
    // assertInvalid('invalid select.28.wasm', 'select/select.28.wasm', 'type mismatch', registered);
