...
void main() {
  ...
  group('func', () {
    group('func.0.wasm', () {
      ...
      returns(
          'local_second_f32_0', () => m.$('local-second-f32', []), $f32('0'));
      returns(
          'local_second_f64_0', () => m.$('local-second-f64', []), $f64('0'));
      ...
      returns('value_block_void_0', () => m.$('value-block-void', []),
          null /*void*/);
      returns('value_block_i32_0', () => m.$('value-block-i32', []), 0x4D);
      returns('value_block_i32_i64_0', () => m.$('value-block-i32-i64', []),
          [1, 2]);
      ...
      returns('return_f64_0', () => m.$('return-f64', []),
          $f64('4053B1EB851EB852'));
      returns('return_i32_f64_0', () => m.$('return-i32-f64', []),
          [0x4E, $f64('4053B1EB851EB852')]);
      returns('return_i32_i32_i32_0', () => m.$('return-i32-i32-i32', []),
          [1, 2, 3]);
      ...
      returns('break_block_i32_i64_0', () => m.$('break-block-i32-i64', []),
          [1, 2]);
      ...
      returns(
          'break_br_table_num_0', () => m.$('break-br_table-num', [0]), 0x32);
      returns(
          'break_br_table_num_1', () => m.$('break-br_table-num', [1]), 0x32);
      returns(
      ...
      returns(
          ...
          () => m.$('break-br_table-num-num', [$i32('FFFFFF9C')]),
          [0x32, 0x33]);
    ...
    // assertInvalid('invalid func.2.wasm', 'func/func.2.wasm', 'unknown type', registered);
    ...
    // assertInvalid('invalid func.16.wasm', 'func/func.16.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.17.wasm', 'func/func.17.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.18.wasm', 'func/func.18.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.19.wasm', 'func/func.19.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.20.wasm', 'func/func.20.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.21.wasm', 'func/func.21.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.22.wasm', 'func/func.22.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.23.wasm', 'func/func.23.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.24.wasm', 'func/func.24.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.25.wasm', 'func/func.25.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.26.wasm', 'func/func.26.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.27.wasm', 'func/func.27.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.28.wasm', 'func/func.28.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.29.wasm', 'func/func.29.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.30.wasm', 'func/func.30.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.31.wasm', 'func/func.31.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.32.wasm', 'func/func.32.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.33.wasm', 'func/func.33.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.34.wasm', 'func/func.34.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.35.wasm', 'func/func.35.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.36.wasm', 'func/func.36.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.37.wasm', 'func/func.37.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.38.wasm', 'func/func.38.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.39.wasm', 'func/func.39.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.40.wasm', 'func/func.40.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.41.wasm', 'func/func.41.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.42.wasm', 'func/func.42.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.43.wasm', 'func/func.43.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.44.wasm', 'func/func.44.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.45.wasm', 'func/func.45.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.46.wasm', 'func/func.46.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.47.wasm', 'func/func.47.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.48.wasm', 'func/func.48.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.49.wasm', 'func/func.49.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.50.wasm', 'func/func.50.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.51.wasm', 'func/func.51.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.52.wasm', 'func/func.52.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.53.wasm', 'func/func.53.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.54.wasm', 'func/func.54.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.55.wasm', 'func/func.55.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.56.wasm', 'func/func.56.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.57.wasm', 'func/func.57.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.58.wasm', 'func/func.58.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.59.wasm', 'func/func.59.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.60.wasm', 'func/func.60.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.61.wasm', 'func/func.61.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.62.wasm', 'func/func.62.wasm', 'type mismatch', registered);
    // assertInvalid('invalid func.63.wasm', 'func/func.63.wasm', 'type mismatch', registered);
