...
void main() {
  ...
  group('return', () {
    ...
    // assertInvalid('invalid return.1.wasm', 'return/return.1.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.2.wasm', 'return/return.2.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.3.wasm', 'return/return.3.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.4.wasm', 'return/return.4.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.5.wasm', 'return/return.5.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.6.wasm', 'return/return.6.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.7.wasm', 'return/return.7.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.8.wasm', 'return/return.8.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.9.wasm', 'return/return.9.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.10.wasm', 'return/return.10.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.11.wasm', 'return/return.11.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.12.wasm', 'return/return.12.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.13.wasm', 'return/return.13.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.14.wasm', 'return/return.14.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.15.wasm', 'return/return.15.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.16.wasm', 'return/return.16.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.17.wasm', 'return/return.17.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.18.wasm', 'return/return.18.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.19.wasm', 'return/return.19.wasm', 'type mismatch', registered);
    // assertInvalid('invalid return.20.wasm', 'return/return.20.wasm', 'type mismatch', registered);
  });
}
