    ...
    group('local_get.0.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/local_get/local_get.0.wasm'));
      ...
      returns('type_param_f32_0',
          () => m.$('type-param-f32', [$f32('408CCCCD')]), $f32('408CCCCD'));
      returns(
          'type_param_f64_0',
      ...
      returns('as_br_if_value_cond_0', () => m.$('as-br_if-value-cond', [0xA]),
          0xA);
      ...
      returns(
          'read_0',
          () => m
              .$('read', [1, $f32('40000000'), $f64('400A666666666666'), 4, 5]),
