...
void main() {
  ...
  group('loop', () {
    ...
    // assertInvalid('invalid loop.12.wasm', 'loop/loop.12.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.13.wasm', 'loop/loop.13.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.14.wasm', 'loop/loop.14.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.15.wasm', 'loop/loop.15.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.16.wasm', 'loop/loop.16.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.17.wasm', 'loop/loop.17.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.18.wasm', 'loop/loop.18.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.19.wasm', 'loop/loop.19.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.20.wasm', 'loop/loop.20.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.21.wasm', 'loop/loop.21.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.22.wasm', 'loop/loop.22.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.23.wasm', 'loop/loop.23.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.24.wasm', 'loop/loop.24.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.25.wasm', 'loop/loop.25.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.26.wasm', 'loop/loop.26.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.27.wasm', 'loop/loop.27.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.28.wasm', 'loop/loop.28.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.29.wasm', 'loop/loop.29.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.30.wasm', 'loop/loop.30.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.31.wasm', 'loop/loop.31.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.32.wasm', 'loop/loop.32.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.33.wasm', 'loop/loop.33.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.34.wasm', 'loop/loop.34.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.35.wasm', 'loop/loop.35.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.36.wasm', 'loop/loop.36.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.37.wasm', 'loop/loop.37.wasm', 'type mismatch', registered);
    // assertInvalid('invalid loop.38.wasm', 'loop/loop.38.wasm', 'type mismatch', registered);
