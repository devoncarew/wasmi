...
void main() {
  ...
  group('elem', () {
    ...
    group('elem.58.wasm', () {
      ...
      action('register-module1',
          () => registered['module1'] = importModuleFrom(m));
      traps('call_7_0', () => named[r'$module1']!.$('call-7', []),
    ...
    group('elem.67.wasm', () {
      ...
      action('register-module4',
          () => registered['module4'] = importModuleFrom(m));
    });
    ...
    group('elem.68.wasm', () {
      ...
      returns(
          'call_imported_elem_0', () => m.$('call_imported_elem', []), 0x2A);
    });
  });
}
