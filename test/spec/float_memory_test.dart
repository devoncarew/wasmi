...
void main() {
  ...
  group('float_memory', () {
    ...
    group('float_memory.1.wasm', () {
      ...
      returns(
          'i64_load_0', () => m.$('i64.load', []), $i64('7FF4000000000000'));
      returns(
          'f64_load_0', () => m.$('f64.load', []), $f64('7FF4000000000000'));
      action('reset_0', () => m.$('reset', []));
      ...
      returns(
          'i64_load_4', () => m.$('i64.load', []), $i64('7FF4000000000000'));
      returns(
          'f64_load_4', () => m.$('f64.load', []), $f64('7FF4000000000000'));
    });
    ...
    group('float_memory.5.wasm', () {
      ...
      returns(
          'i64_load_0', () => m.$('i64.load', []), $i64('7FFC000000000001'));
      returns(
          'f64_load_0', () => m.$('f64.load', []), $f64('7FFC000000000001'));
      action('reset_0', () => m.$('reset', []));
      returns('i64_load_1', () => m.$('i64.load', []), 0);
      returns('f64_load_1', () => m.$('f64.load', []), $f64('0'));
      action('f64_store_0', () => m.$('f64.store', []));
      ...
      action('i64_store_0', () => m.$('i64.store', []));
      returns(
          'i64_load_4', () => m.$('i64.load', []), $i64('7FFC000000000001'));
      returns(
          'f64_load_4', () => m.$('f64.load', []), $f64('7FFC000000000001'));
    });
  });
}
