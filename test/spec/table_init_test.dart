...
void main() {
  ...
  group('table_init', () {
    ...
    // assertInvalid('invalid table_init.7.wasm', 'table_init/table_init.7.wasm', 'unknown elem segment 0', registered);
    // assertInvalid('invalid table_init.8.wasm', 'table_init/table_init.8.wasm', 'unknown table 0', registered);
    // assertInvalid('invalid table_init.9.wasm', 'table_init/table_init.9.wasm', 'unknown elem segment 4', registered);
    // assertInvalid('invalid table_init.10.wasm', 'table_init/table_init.10.wasm', 'unknown table 0', registered);
    ...
    // assertInvalid('invalid table_init.32.wasm', 'table_init/table_init.32.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.33.wasm', 'table_init/table_init.33.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.34.wasm', 'table_init/table_init.34.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.35.wasm', 'table_init/table_init.35.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.36.wasm', 'table_init/table_init.36.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.37.wasm', 'table_init/table_init.37.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.38.wasm', 'table_init/table_init.38.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.39.wasm', 'table_init/table_init.39.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.40.wasm', 'table_init/table_init.40.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.41.wasm', 'table_init/table_init.41.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.42.wasm', 'table_init/table_init.42.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.43.wasm', 'table_init/table_init.43.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.44.wasm', 'table_init/table_init.44.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.45.wasm', 'table_init/table_init.45.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.46.wasm', 'table_init/table_init.46.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.47.wasm', 'table_init/table_init.47.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.48.wasm', 'table_init/table_init.48.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.49.wasm', 'table_init/table_init.49.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.50.wasm', 'table_init/table_init.50.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.51.wasm', 'table_init/table_init.51.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.52.wasm', 'table_init/table_init.52.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.53.wasm', 'table_init/table_init.53.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.54.wasm', 'table_init/table_init.54.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.55.wasm', 'table_init/table_init.55.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.56.wasm', 'table_init/table_init.56.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.57.wasm', 'table_init/table_init.57.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.58.wasm', 'table_init/table_init.58.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.59.wasm', 'table_init/table_init.59.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.60.wasm', 'table_init/table_init.60.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.61.wasm', 'table_init/table_init.61.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.62.wasm', 'table_init/table_init.62.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.63.wasm', 'table_init/table_init.63.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.64.wasm', 'table_init/table_init.64.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.65.wasm', 'table_init/table_init.65.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.66.wasm', 'table_init/table_init.66.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.67.wasm', 'table_init/table_init.67.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.68.wasm', 'table_init/table_init.68.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.69.wasm', 'table_init/table_init.69.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.70.wasm', 'table_init/table_init.70.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.71.wasm', 'table_init/table_init.71.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.72.wasm', 'table_init/table_init.72.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.73.wasm', 'table_init/table_init.73.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.74.wasm', 'table_init/table_init.74.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.75.wasm', 'table_init/table_init.75.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.76.wasm', 'table_init/table_init.76.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.77.wasm', 'table_init/table_init.77.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.78.wasm', 'table_init/table_init.78.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.79.wasm', 'table_init/table_init.79.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.80.wasm', 'table_init/table_init.80.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.81.wasm', 'table_init/table_init.81.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.82.wasm', 'table_init/table_init.82.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.83.wasm', 'table_init/table_init.83.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.84.wasm', 'table_init/table_init.84.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.85.wasm', 'table_init/table_init.85.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.86.wasm', 'table_init/table_init.86.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.87.wasm', 'table_init/table_init.87.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.88.wasm', 'table_init/table_init.88.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.89.wasm', 'table_init/table_init.89.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.90.wasm', 'table_init/table_init.90.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.91.wasm', 'table_init/table_init.91.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.92.wasm', 'table_init/table_init.92.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.93.wasm', 'table_init/table_init.93.wasm', 'type mismatch', registered);
    // assertInvalid('invalid table_init.94.wasm', 'table_init/table_init.94.wasm', 'type mismatch', registered);
