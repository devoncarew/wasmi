...
void main() {
  ...
  group('float_exprs.23.wasm', () {
    ...
    returns('f32_no_fold_div_0_4', () => m.$('f32.no_fold_div_0', [$f32('0')]),
        double.nan);
    ...
    returns(
        ...
        $f64('FFF0000000000000'));
    returns('f64_no_fold_div_0_4', () => m.$('f64.no_fold_div_0', [$f64('0')]),
        double.nan);
    returns('f64_no_fold_div_0_5',
        () => m.$('f64.no_fold_div_0', [$f64('8000000000000000')]), double.nan);
    returns('f64_no_fold_div_0_6',
        () => m.$('f64.no_fold_div_0', [$f64('7FF8000000000000')]), double.nan);
    returns('f64_no_fold_div_0_7',
        () => m.$('f64.no_fold_div_0', [$f64('7FF4000000000000')]), double.nan);
  });
  ...
  group('float_exprs.34.wasm', () {
    ...
    returns('f32_no_fold_div2_mul2_0',
        () => m.$('f32.no_fold_div2_mul2', [$f32('FFFFFF')]), $f32('1000000'));
    returns(
  ...
  group('float_exprs.36.wasm', () {
    ...
    returns(
        ...
        $f32('80000001'));
    returns('no_fold_promote_demote_5',
        () => m.$('no_fold_promote_demote', [$f32('7FFFFF')]), $f32('7FFFFF'));
    returns(
        'no_fold_promote_demote_6',
        () => m.$('no_fold_promote_demote', [$f32('807FFFFF')]),
        $f32('807FFFFF'));
    returns('no_fold_promote_demote_7',
        () => m.$('no_fold_promote_demote', [$f32('800000')]), $f32('800000'));
    returns(
  ...
  group('float_exprs.37.wasm', () {
    ...
    returns(
        ...
        () => m.$(
            'no_demote_mixed_add', [$f64('3A0F51A9D04854F9'), $f32('41FA74E')]),
        $f32('107A8D4F'));
    returns(
  ...
  group('float_exprs.39.wasm', () {
    ...
    returns(
      ...
      () =>
          m.$('f64.i64.no_fold_trunc_s_convert_u', [$f64('BFF8000000000000')]),
  ...
  group('float_exprs.43.wasm', () {
    ...
    returns(
        ...
        () =>
            m.$('f64.no_fold_lt_select', [$f64('0'), $f64('7FF8000000000000')]),
        $f64('7FF8000000000000'));
    returns(
        'f64_no_fold_lt_select_1',
        () =>
            m.$('f64.no_fold_lt_select', [$f64('7FF8000000000000'), $f64('0')]),
        $f64('0'));
    returns(
        'f64_no_fold_lt_select_2',
        () =>
            m.$('f64.no_fold_lt_select', [$f64('0'), $f64('8000000000000000')]),
        $f64('8000000000000000'));
    returns(
        'f64_no_fold_lt_select_3',
        () =>
            m.$('f64.no_fold_lt_select', [$f64('8000000000000000'), $f64('0')]),
        $f64('0'));
    returns(
        'f64_no_fold_le_select_0',
        () =>
            m.$('f64.no_fold_le_select', [$f64('0'), $f64('7FF8000000000000')]),
        $f64('7FF8000000000000'));
    returns(
        'f64_no_fold_le_select_1',
        () =>
            m.$('f64.no_fold_le_select', [$f64('7FF8000000000000'), $f64('0')]),
        $f64('0'));
    returns(
        'f64_no_fold_le_select_2',
        () =>
            m.$('f64.no_fold_le_select', [$f64('0'), $f64('8000000000000000')]),
        $f64('0'));
    returns(
        'f64_no_fold_le_select_3',
        () =>
            m.$('f64.no_fold_le_select', [$f64('8000000000000000'), $f64('0')]),
        $f64('8000000000000000'));
    returns(
        'f64_no_fold_gt_select_0',
        () =>
            m.$('f64.no_fold_gt_select', [$f64('0'), $f64('7FF8000000000000')]),
        $f64('7FF8000000000000'));
    returns(
        'f64_no_fold_gt_select_1',
        () =>
            m.$('f64.no_fold_gt_select', [$f64('7FF8000000000000'), $f64('0')]),
        $f64('0'));
    returns(
        'f64_no_fold_gt_select_2',
        () =>
            m.$('f64.no_fold_gt_select', [$f64('0'), $f64('8000000000000000')]),
        $f64('8000000000000000'));
    returns(
        'f64_no_fold_gt_select_3',
        () =>
            m.$('f64.no_fold_gt_select', [$f64('8000000000000000'), $f64('0')]),
        $f64('0'));
    returns(
        'f64_no_fold_ge_select_0',
        () =>
            m.$('f64.no_fold_ge_select', [$f64('0'), $f64('7FF8000000000000')]),
        $f64('7FF8000000000000'));
    returns(
        'f64_no_fold_ge_select_1',
        () =>
            m.$('f64.no_fold_ge_select', [$f64('7FF8000000000000'), $f64('0')]),
        $f64('0'));
    returns(
        'f64_no_fold_ge_select_2',
        () =>
            m.$('f64.no_fold_ge_select', [$f64('0'), $f64('8000000000000000')]),
        $f64('0'));
    returns(
        'f64_no_fold_ge_select_3',
        () =>
            m.$('f64.no_fold_ge_select', [$f64('8000000000000000'), $f64('0')]),
        $f64('8000000000000000'));
  });
  ...
  group('float_exprs.53.wasm', () {
    ...
    returns(
        'thepast2_0',
        () => m.$(
            'thepast2', [$f32('1000000'), $f32('3F000000'), $f32('3F800000')]),
        $f32('800000'));
  });
  ...
  group('float_exprs.57.wasm', () {
    ...
    returns(
        ...
        () => m.$(
            'f32.no_algebraic_factoring', [$f32('A477B3C7'), $f32('24E0B05C')]),
        $f32('8A094A01'));
    returns(
        'f32_no_algebraic_factoring_1',
        () => m.$(
            'f32.no_algebraic_factoring', [$f32('CB96BB5E'), $f32('4BFA044E')]),
        $f32('D81B6C4D'));
    returns(
        'f32_no_algebraic_factoring_2',
        () => m.$(
            'f32.no_algebraic_factoring', [$f32('563E5159'), $f32('D704289E')]),
        $f32('EE6D886F'));
    returns(
        'f32_no_algebraic_factoring_3',
        () => m.$(
            'f32.no_algebraic_factoring', [$f32('483EAF18'), $f32('C363C1DA')]),
        $f32('510E0853'));
    returns(
        'f32_no_algebraic_factoring_4',
        () => m.$(
            'f32.no_algebraic_factoring', [$f32('C36D7CB0'), $f32('C96D6358')]),
        $f32('D35C2117'));
    returns(
  ...
  group('float_exprs.58.wasm', () {
    ...
    returns(
        'f32_no_algebraic_factoring_0',
        () => m.$(
            'f32.no_algebraic_factoring', [$f32('28C7160A'), $f32('2C5D6ACD')]),
        $f32('993F7F28'));
    returns(
        'f32_no_algebraic_factoring_1',
        () => m.$(
            'f32.no_algebraic_factoring', [$f32('D43F78C9'), $f32('D06D8C25')]),
        $f32('690F3499'));
    returns(
        'f32_no_algebraic_factoring_2',
        () => m.$(
            'f32.no_algebraic_factoring', [$f32('39BF5A2C'), $f32('B929624C')]),
        $f32('33E605E3'));
    returns(
        'f32_no_algebraic_factoring_3',
        () => m.$(
            'f32.no_algebraic_factoring', [$f32('29933AE3'), $f32('A8F6E98D')]),
        $f32('138B94A6'));
    returns(
        'f32_no_algebraic_factoring_4',
        () => m.$(
            'f32.no_algebraic_factoring', [$f32('594D2FC9'), $f32('D995804C')]),
        $f32('F338C4D3'));
    returns(
        'f64_no_algebraic_factoring_0',
        () => m.$('f64.no_algebraic_factoring',
  ...
  group('float_exprs.72.wasm', () {
    ...
    returns(
        ...
        () =>
            m.$('f32.no_fold_mul_sqrts', [$f32('11A0C68A'), $f32('2FE329AE')]),
        $f32('20BF1B9D'));
    returns(
        'f32_no_fold_mul_sqrts_2',
        () =>
            m.$('f32.no_fold_mul_sqrts', [$f32('13A6F3F0'), $f32('42C27F8C')]),
        $f32('2B343334'));
    returns(
        'f32_no_fold_mul_sqrts_3',
        () =>
            m.$('f32.no_fold_mul_sqrts', [$f32('723C048F'), $f32('3B40FF5C')]),
        $f32('56BE7DCC'));
    returns(
        'f32_no_fold_mul_sqrts_4',
        () =>
            m.$('f32.no_fold_mul_sqrts', [$f32('23AC1D00'), $f32('3B0A5D15')]),
        $f32('2F5A3D47'));
    returns(
  ...
  group('float_exprs.73.wasm', () {
    ...
    returns(
        ...
        () =>
            m.$('f32.no_fold_div_sqrts', [$f32('CC5F54DD'), $f32('A2EDBBB7')]),
        double.nan);
    returns(
        'f32_no_fold_div_sqrts_1',
        () =>
            m.$('f32.no_fold_div_sqrts', [$f32('4FDCC1DB'), $f32('4D480F8F')]),
        $f32('40BE26FB'));
    returns(
    ...
    returns(
        ...
        () =>
            m.$('f32.no_fold_div_sqrts', [$f32('5D597222'), $f32('30ADC58B')]),
        $f32('55CA7E54'));
    returns(
  ...
  group('float_exprs.74.wasm', () {
    ...
    returns(
      ...
      () =>
          m.$('f32.no_fold_mul_sqrt_div', [$f32('E87A53E5'), $f32('6DE04D6F')]),
      $f32('FF800000'),
      skip: 'failed',
    );
    returns(
      ...
      () =>
          m.$('f32.no_fold_mul_sqrt_div', [$f32('83C85F8E'), $f32('F46DF44')]),
      $f32('80000000'),
      skip: 'failed',
    );
    returns(
        ...
        () =>
            m.$('f32.no_fold_mul_sqrt_div', [$f32('4E42B874'), $f32('242FA6')]),
        $f32('6E371C8D'));
    returns(
  ...
  group('float_exprs.76.wasm', () {
    ...
    returns('f32_recoding_eq_0',
        () => m.$('f32.recoding_eq', [$f32('FF800000'), $f32('40400000')]), 1);
    returns('f32_recoding_le_0',
        () => m.$('f32.recoding_le', [$f32('FF800000'), $f32('40400000')]), 1);
    returns('f32_recoding_lt_0',
        () => m.$('f32.recoding_lt', [$f32('FF800000'), $f32('40400000')]), 0);
    ...
    returns(
        ...
        () => m.$('f64.recoding_lt',
            [$f64('FFF0000000000000'), $f64('4008000000000000')]),
        0);
    returns('f64_recoding_eq_1',
        () => m.$('f64.recoding_eq', [$f64('0'), $f64('3FF0000000000000')]), 1);
    returns('f64_recoding_le_1',
        () => m.$('f64.recoding_le', [$f64('0'), $f64('3FF0000000000000')]), 1);
    returns('f64_recoding_lt_1',
        () => m.$('f64.recoding_lt', [$f64('0'), $f64('3FF0000000000000')]), 0);
    returns(
        'recoding_demote_0',
        () => m
  ...
  group('float_exprs.81.wasm', () {
    ...
    returns(
      ...
      () =>
          m.$('f32.no_fold_sub1_mul_add', [$f32('2F800000'), $f32('3F800000')]),
      $f32('0'),
      skip: 'failed',
    );
    returns(
  ...
  group('float_exprs.86.wasm', () {
    ...
    returns(
        ...
        () =>
            m.$('f64.no_trichotomy_lt', [$f64('0'), $f64('7FF8000000000000')]),
        0);
    returns(
        'f64_no_trichotomy_le_0',
        () =>
            m.$('f64.no_trichotomy_le', [$f64('0'), $f64('7FF8000000000000')]),
        0);
    returns(
        'f64_no_trichotomy_gt_0',
        () =>
            m.$('f64.no_trichotomy_gt', [$f64('0'), $f64('7FF8000000000000')]),
        0);
    returns(
        'f64_no_trichotomy_ge_0',
        () =>
            m.$('f64.no_trichotomy_ge', [$f64('0'), $f64('7FF8000000000000')]),
        0);
  });
  ...
  group('float_exprs.87.wasm', () {
    ...
    returns(
        ...
        () =>
            m.$('f64.nonarithmetic_nan_bitpattern', [$i64('7FF8000000003210')]),
        $i64('FFF8000000003210'));
    returns(
        'f64_nonarithmetic_nan_bitpattern_1',
        () =>
            m.$('f64.nonarithmetic_nan_bitpattern', [$i64('FFF8000000003210')]),
        $i64('7FF8000000003210'));
    returns(
        'f64_nonarithmetic_nan_bitpattern_2',
        () =>
            m.$('f64.nonarithmetic_nan_bitpattern', [$i64('7FF0000000003210')]),
        $i64('FFF0000000003210'));
    returns(
        'f64_nonarithmetic_nan_bitpattern_3',
        () =>
            m.$('f64.nonarithmetic_nan_bitpattern', [$i64('FFF0000000003210')]),
    ...
    returns(
        ...
        $i32('7FC00000'));
    returns('f32_no_fold_mul_one_0',
        () => m.$('f32.no_fold_mul_one', [$i32('7FA00000')]), $i32('7FC00000'));
    returns(
        'f32_no_fold_neg1_mul_0',
        () => m.$('f32.no_fold_neg1_mul', [$i32('7FA00000')]),
        $i32('7FC00000'));
    returns('f32_no_fold_div_one_0',
        () => m.$('f32.no_fold_div_one', [$i32('7FA00000')]), $i32('7FC00000'));
    returns(
  ...
  group('float_exprs.93.wasm', () {
    ...
    returns(
        'point_four_0',
        () => m.$(
            'point_four', [$f64('4010000000000000'), $f64('4024000000000000')]),
        0);
  });
