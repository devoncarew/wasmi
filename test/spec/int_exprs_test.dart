...
void main() {
  ...
  group('int_exprs', () {
    group('int_exprs.0.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.0.wasm'));
    ...
    group('int_exprs.1.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.1.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });
    ...
    group('int_exprs.2.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.2.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });
    ...
    group('int_exprs.3.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.3.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });
    ...
    group('int_exprs.4.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.4.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });

      returns('i32_no_fold_shr_s_shl_0',
          () => m.$('i32.no_fold_shr_s_shl', [1]), 0);
      returns('i32_no_fold_shr_u_shl_0',
          () => m.$('i32.no_fold_shr_u_shl', [1]), 0);
      returns('i64_no_fold_shr_s_shl_0',
          () => m.$('i64.no_fold_shr_s_shl', [1]), 0);
      returns('i64_no_fold_shr_u_shl_0',
          () => m.$('i64.no_fold_shr_u_shl', [1]), 0);
    });
    ...
    group('int_exprs.5.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.5.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });

      returns('i32_no_fold_div_s_mul_0',
          () => m.$('i32.no_fold_div_s_mul', [1]), 0);
      returns('i32_no_fold_div_u_mul_0',
          () => m.$('i32.no_fold_div_u_mul', [1]), 0);
      returns('i64_no_fold_div_s_mul_0',
          () => m.$('i64.no_fold_div_s_mul', [1]), 0);
      returns('i64_no_fold_div_u_mul_0',
          () => m.$('i64.no_fold_div_u_mul', [1]), 0);
    });
    ...
    group('int_exprs.6.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.6.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });

      traps('i32_no_fold_div_s_self_0',
          () => m.$('i32.no_fold_div_s_self', [0]), 'integer divide by zero');
      traps('i32_no_fold_div_u_self_0',
          () => m.$('i32.no_fold_div_u_self', [0]), 'integer divide by zero');
      traps('i64_no_fold_div_s_self_0',
          () => m.$('i64.no_fold_div_s_self', [0]), 'integer divide by zero');
      traps('i64_no_fold_div_u_self_0',
          () => m.$('i64.no_fold_div_u_self', [0]), 'integer divide by zero');
    });
    ...
    group('int_exprs.7.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.7.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });

      traps('i32_no_fold_rem_s_self_0',
          () => m.$('i32.no_fold_rem_s_self', [0]), 'integer divide by zero');
      traps('i32_no_fold_rem_u_self_0',
          () => m.$('i32.no_fold_rem_u_self', [0]), 'integer divide by zero');
      traps('i64_no_fold_rem_s_self_0',
          () => m.$('i64.no_fold_rem_s_self', [0]), 'integer divide by zero');
      traps('i64_no_fold_rem_u_self_0',
          () => m.$('i64.no_fold_rem_u_self', [0]), 'integer divide by zero');
    });
    ...
    group('int_exprs.8.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.8.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });
    ...
    group('int_exprs.9.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.9.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });

      returns(
          'i32_no_fold_div_s_2_0',
          () => m.$('i32.no_fold_div_s_2', [$i32('FFFFFFF5')]),
          $i32('FFFFFFFB'));
      returns(
    ...
    group('int_exprs.10.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.10.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });

      returns(
          'i32_no_fold_rem_s_2_0',
          () => m.$('i32.no_fold_rem_s_2', [$i32('FFFFFFF5')]),
          $i32('FFFFFFFF'));
      returns(
    ...
    group('int_exprs.11.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.11.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });
    ...
    group('int_exprs.12.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.12.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });
    ...
    group('int_exprs.13.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.13.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });
    ...
    group('int_exprs.14.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.14.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });
    ...
    group('int_exprs.15.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.15.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });
    ...
    group('int_exprs.16.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.16.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });
    ...
    group('int_exprs.17.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.17.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });
    ...
    group('int_exprs.18.wasm', () {
      ...
      setUpAll(() {
        def = ModuleDefinition.parse(
            File('test/spec/int_exprs/int_exprs.18.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });
