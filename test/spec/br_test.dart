  ...
  group('br', () {
    group('br.0.wasm', () {
      ...
      returns('as_call_indirect_last_0', () => m.$('as-call_indirect-last', []),
          0x17);
      returns('as_call_indirect_all_0', () => m.$('as-call_indirect-all', []),
          0x18);
      returns(
    ...
    // assertInvalid('invalid br.1.wasm', 'br/br.1.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.2.wasm', 'br/br.2.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.3.wasm', 'br/br.3.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.4.wasm', 'br/br.4.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.5.wasm', 'br/br.5.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.6.wasm', 'br/br.6.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.7.wasm', 'br/br.7.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.8.wasm', 'br/br.8.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.9.wasm', 'br/br.9.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.10.wasm', 'br/br.10.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.11.wasm', 'br/br.11.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.12.wasm', 'br/br.12.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.13.wasm', 'br/br.13.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.14.wasm', 'br/br.14.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.15.wasm', 'br/br.15.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.16.wasm', 'br/br.16.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.17.wasm', 'br/br.17.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br.18.wasm', 'br/br.18.wasm', 'unknown label', registered);
    // assertInvalid('invalid br.19.wasm', 'br/br.19.wasm', 'unknown label', registered);
    // assertInvalid('invalid br.20.wasm', 'br/br.20.wasm', 'unknown label', registered);
  });
}
