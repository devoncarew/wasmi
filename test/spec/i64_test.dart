...
void main() {
  ...
  group('i64', () {
    ...
    // assertInvalid('invalid i64.1.wasm', 'i64/i64.1.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.2.wasm', 'i64/i64.2.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.3.wasm', 'i64/i64.3.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.4.wasm', 'i64/i64.4.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.5.wasm', 'i64/i64.5.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.6.wasm', 'i64/i64.6.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.7.wasm', 'i64/i64.7.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.8.wasm', 'i64/i64.8.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.9.wasm', 'i64/i64.9.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.10.wasm', 'i64/i64.10.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.11.wasm', 'i64/i64.11.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.12.wasm', 'i64/i64.12.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.13.wasm', 'i64/i64.13.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.14.wasm', 'i64/i64.14.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.15.wasm', 'i64/i64.15.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.16.wasm', 'i64/i64.16.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.17.wasm', 'i64/i64.17.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.18.wasm', 'i64/i64.18.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.19.wasm', 'i64/i64.19.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.20.wasm', 'i64/i64.20.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.21.wasm', 'i64/i64.21.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.22.wasm', 'i64/i64.22.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.23.wasm', 'i64/i64.23.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.24.wasm', 'i64/i64.24.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.25.wasm', 'i64/i64.25.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.26.wasm', 'i64/i64.26.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.27.wasm', 'i64/i64.27.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.28.wasm', 'i64/i64.28.wasm', 'type mismatch', registered);
    // assertInvalid('invalid i64.29.wasm', 'i64/i64.29.wasm', 'type mismatch', registered);
