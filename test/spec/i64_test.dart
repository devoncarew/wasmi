...
void main() {
  ...
  group('i64.0.wasm', () {
    ...
    returns(
        ...
        0);
    returns('add_7', () => m.$('add', [$i64('3FFFFFFF'), 1]), $i64('40000000'));
    ...
    returns(
        'div_s_7',
        () =>
            m.$('div_s', [$i64('FFFFFFFFFFFFFFFF'), $i64('FFFFFFFFFFFFFFFF')]),
        1);
    ...
    returns(
        'div_s_13',
        () =>
            m.$('div_s', [$i64('FFFFFFFFFFFFFFFB'), $i64('FFFFFFFFFFFFFFFE')]),
        2);
    ...
    returns(
        'div_s_17',
        () =>
            m.$('div_s', [$i64('FFFFFFFFFFFFFFF9'), $i64('FFFFFFFFFFFFFFFD')]),
        2);
    ...
    returns(
        'div_u_4',
        () =>
            m.$('div_u', [$i64('FFFFFFFFFFFFFFFF'), $i64('FFFFFFFFFFFFFFFF')]),
        1);
    returns(
      'div_u_5',
    ...
    returns(
        'rem_s_2',
        () =>
            m.$('rem_s', [$i64('7FFFFFFFFFFFFFFF'), $i64('FFFFFFFFFFFFFFFF')]),
        0);
    ...
    returns(
        'rem_s_6',
        () =>
            m.$('rem_s', [$i64('FFFFFFFFFFFFFFFF'), $i64('FFFFFFFFFFFFFFFF')]),
        0);
    returns(
        'rem_s_7',
        () =>
            m.$('rem_s', [$i64('8000000000000000'), $i64('FFFFFFFFFFFFFFFF')]),
        0);
    ...
    returns(
        'rem_s_13',
        () =>
            m.$('rem_s', [$i64('FFFFFFFFFFFFFFFB'), $i64('FFFFFFFFFFFFFFFE')]),
        $i64('FFFFFFFFFFFFFFFF'));
    ...
    returns(
        'rem_s_17',
        () =>
            m.$('rem_s', [$i64('FFFFFFFFFFFFFFF9'), $i64('FFFFFFFFFFFFFFFD')]),
        $i64('FFFFFFFFFFFFFFFF'));
    ...
    returns(
        'rem_u_4',
        () =>
            m.$('rem_u', [$i64('FFFFFFFFFFFFFFFF'), $i64('FFFFFFFFFFFFFFFF')]),
        0);
    returns(
      'rem_u_5',
    ...
    returns(
        'shr_s_14',
        () =>
            m.$('shr_s', [$i64('FFFFFFFFFFFFFFFF'), $i64('FFFFFFFFFFFFFFFF')]),
        $i64('FFFFFFFFFFFFFFFF'));
    returns(
        'shr_s_15',
        () =>
            m.$('shr_s', [$i64('FFFFFFFFFFFFFFFF'), $i64('7FFFFFFFFFFFFFFF')]),
        $i64('FFFFFFFFFFFFFFFF'));
    returns(
        'shr_s_16',
        () =>
            m.$('shr_s', [$i64('FFFFFFFFFFFFFFFF'), $i64('8000000000000000')]),
        $i64('FFFFFFFFFFFFFFFF'));
    ...
    returns(
        'shr_u_14',
        () =>
            m.$('shr_u', [$i64('FFFFFFFFFFFFFFFF'), $i64('FFFFFFFFFFFFFFFF')]),
        1);
    returns(
        'shr_u_15',
        () =>
            m.$('shr_u', [$i64('FFFFFFFFFFFFFFFF'), $i64('7FFFFFFFFFFFFFFF')]),
        1);
    returns(
        'shr_u_16',
        () =>
            m.$('shr_u', [$i64('FFFFFFFFFFFFFFFF'), $i64('8000000000000000')]),
        $i64('FFFFFFFFFFFFFFFF'));
    ...
    returns(
        ...
        $i64('55E891A77AB3C04E'));
    returns('rotl_11', () => m.$('rotl', [1, 0x3F]), $i64('8000000000000000'));
    ...
    returns('rotr_12', () => m.$('rotr', [$i64('8000000000000000'), 0x3F]), 1);
    ...
    returns('popcnt_0', () => m.$('popcnt', [$i64('FFFFFFFFFFFFFFFF')]), 0x40);
    returns('popcnt_1', () => m.$('popcnt', [0]), 0);
    returns('popcnt_2', () => m.$('popcnt', [0x8000]), 1);
    returns('popcnt_3', () => m.$('popcnt', [$i64('8000800080008000')]), 4);
    returns('popcnt_4', () => m.$('popcnt', [$i64('7FFFFFFFFFFFFFFF')]), 0x3F);
    returns('popcnt_5', () => m.$('popcnt', [$i64('AAAAAAAA55555555')]), 0x20);
    returns('popcnt_6', () => m.$('popcnt', [$i64('99999999AAAAAAAA')]), 0x20);
    returns('popcnt_7', () => m.$('popcnt', [$i64('DEADBEEFDEADBEEF')]), 0x30);
    ...
    returns('extend16_s_3', () => m.$('extend16_s', [0xFFFF]),
        $i64('FFFFFFFFFFFFFFFF'));
    returns(
        'extend16_s_4', () => m.$('extend16_s', [$i64('123456789ABC0000')]), 0);
    returns('extend16_s_5', () => m.$('extend16_s', [$i64('FEDCBA9876548000')]),
        $i64('FFFFFFFFFFFF8000'));
    returns('extend16_s_6', () => m.$('extend16_s', [$i64('FFFFFFFFFFFFFFFF')]),
        $i64('FFFFFFFFFFFFFFFF'));
    ...
    returns('extend32_s_6', () => m.$('extend32_s', [$i64('FFFFFFFF')]),
        $i64('FFFFFFFFFFFFFFFF'));
    returns(
        'extend32_s_7', () => m.$('extend32_s', [$i64('123456700000000')]), 0);
    returns('extend32_s_8', () => m.$('extend32_s', [$i64('FEDCBA9880000000')]),
        $i64('FFFFFFFF80000000'));
    returns('extend32_s_9', () => m.$('extend32_s', [$i64('FFFFFFFFFFFFFFFF')]),
        $i64('FFFFFFFFFFFFFFFF'));
