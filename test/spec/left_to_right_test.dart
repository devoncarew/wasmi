...
void main() {
  ...
  group('left-to-right', () {
    group('left-to-right.0.wasm', () {
      ...
      returns(
          'i32_call_indirect_0', () => m.$('i32_call_indirect', []), 0x10204);
      returns(
          'i64_call_indirect_0', () => m.$('i64_call_indirect', []), 0x10204);
      ...
      returns(
          'f32_call_indirect_0', () => m.$('f32_call_indirect', []), 0x10204);
      returns(
          'f64_call_indirect_0', () => m.$('f64_call_indirect', []), 0x10204);
