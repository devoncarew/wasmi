...
void main() {
  ...
  group('call', () {
    group('call.0.wasm', () {
      ...
      returns('as_binary_all_operands_0',
          () => m.$('as-binary-all-operands', []), 7);
      ...
      returns('fac_acc_3', () => m.$('fac-acc', [0x19, 1]),
      ...
      returns('as_call_indirect_first_0',
          () => m.$('as-call_indirect-first', []), 0x132);
      returns(
      ...
      returns(
          'as_local_set_value_0', () => m.$('as-local.set-value', []), 0x132);
      returns(
          'as_local_tee_value_0', () => m.$('as-local.tee-value', []), 0x132);
      returns(
    ...
    // assertInvalid('invalid call.1.wasm', 'call/call.1.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.2.wasm', 'call/call.2.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.3.wasm', 'call/call.3.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.4.wasm', 'call/call.4.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.5.wasm', 'call/call.5.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.6.wasm', 'call/call.6.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.7.wasm', 'call/call.7.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.8.wasm', 'call/call.8.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.9.wasm', 'call/call.9.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.10.wasm', 'call/call.10.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.11.wasm', 'call/call.11.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.12.wasm', 'call/call.12.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.13.wasm', 'call/call.13.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.14.wasm', 'call/call.14.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.15.wasm', 'call/call.15.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.16.wasm', 'call/call.16.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call.17.wasm', 'call/call.17.wasm', 'unknown function', registered);
    // assertInvalid('invalid call.18.wasm', 'call/call.18.wasm', 'unknown function', registered);
  });
}
