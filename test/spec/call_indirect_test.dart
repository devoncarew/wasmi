...
void main() {
  ...
  group('call_indirect', () {
    group('call_indirect.0.wasm', () {
      ...
      returns(
          'type_f64_0', () => m.$('type-f64', []), $f64('40AEC80000000000'));
      ...
      returns('type_first_f32_0', () => m.$('type-first-f32', []),
          $f32('3FA8F5C3'));
      ...
      returns(
          ...
          () => m.$('dispatch-structural-f64', [0x19]),
          $f64('4116260000000000'));
      returns(
          'dispatch_structural_f64_2',
          () => m.$('dispatch-structural-f64', [0x1C]),
          $f64('404B800000000000'));
      returns(
          'dispatch_structural_f64_3',
          () => m.$('dispatch-structural-f64', [0x16]),
      ...
      returns(
          'as_unary_operand_0', () => m.$('as-unary-operand', []), $f32('0'));
    ...
    group('call_indirect.1.wasm', () {
      ...
      traps(
          'call_3_2', () => m.$('call-3', [2, 3, 2]), 'uninitialized element');
    ...
    // assertInvalid('invalid call_indirect.13.wasm', 'call_indirect/call_indirect.13.wasm', 'unknown table', registered);
    // assertInvalid('invalid call_indirect.14.wasm', 'call_indirect/call_indirect.14.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call_indirect.15.wasm', 'call_indirect/call_indirect.15.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call_indirect.16.wasm', 'call_indirect/call_indirect.16.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call_indirect.17.wasm', 'call_indirect/call_indirect.17.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call_indirect.18.wasm', 'call_indirect/call_indirect.18.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call_indirect.19.wasm', 'call_indirect/call_indirect.19.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call_indirect.20.wasm', 'call_indirect/call_indirect.20.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call_indirect.21.wasm', 'call_indirect/call_indirect.21.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call_indirect.22.wasm', 'call_indirect/call_indirect.22.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call_indirect.23.wasm', 'call_indirect/call_indirect.23.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call_indirect.24.wasm', 'call_indirect/call_indirect.24.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call_indirect.25.wasm', 'call_indirect/call_indirect.25.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call_indirect.26.wasm', 'call_indirect/call_indirect.26.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call_indirect.27.wasm', 'call_indirect/call_indirect.27.wasm', 'type mismatch', registered);
    // assertInvalid('invalid call_indirect.28.wasm', 'call_indirect/call_indirect.28.wasm', 'type mismatch', registered);
