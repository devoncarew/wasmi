...
void main() {
  ...
  group('bulk.4.wasm', () {
    ...
    traps('init_5', () => m.$('init', [0x10001, 0, 0]),
        'out of bounds memory access');
    traps(
        'init_6', () => m.$('init', [0, 5, 0]), 'out of bounds memory access');
  });
  ...
  group('bulk.8.wasm', () {
    ...
    traps('init_0', () => m.$('init', [2, 0, 2]), 'out of bounds table access');
    traps(
      'call_0',
      () => m.$('call', [2]),
    ...
    action('init_4', () => m.$('init', [0, 4, 0]));
    traps('init_5', () => m.$('init', [4, 0, 0]), 'out of bounds table access');
    traps('init_6', () => m.$('init', [0, 5, 0]), 'out of bounds table access');
  });
  ...
  group('bulk.12.wasm', () {
    ...
    traps(
        'copy_7', () => m.$('copy', [0xB, 0, 0]), 'out of bounds table access');
    traps(
        'copy_8', () => m.$('copy', [0, 0xB, 0]), 'out of bounds table access');
  });
}
