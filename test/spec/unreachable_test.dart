...
void main() {
  ...
  group('unreachable.0.wasm', () {
    ...
    traps('as_br_table_value_2_0', () => m.$('as-br_table-value-2', []),
        'unreachable');
    traps('as_br_table_value_index_0', () => m.$('as-br_table-value-index', []),
        'unreachable');
    traps('as_br_table_value_and_index_0',
        () => m.$('as-br_table-value-and-index', []), 'unreachable');
    traps('as_return_value_0', () => m.$('as-return-value', []), 'unreachable');
    ...
    traps('as_if_then_no_else_0', () => m.$('as-if-then-no-else', [1, 6]),
        'unreachable');
    returns('as_if_then_no_else_1', () => m.$('as-if-then-no-else', [0, 6]), 6);
    ...
    traps('as_global_set_value_0', () => m.$('as-global.set-value', []),
        'unreachable');
    traps('as_load_address_0', () => m.$('as-load-address', []), 'unreachable');
    traps(
        'as_loadN_address_0', () => m.$('as-loadN-address', []), 'unreachable');
    traps(
        'as_store_address_0', () => m.$('as-store-address', []), 'unreachable');
    traps('as_store_value_0', () => m.$('as-store-value', []), 'unreachable');
    traps('as_storeN_address_0', () => m.$('as-storeN-address', []),
        'unreachable');
    traps('as_storeN_value_0', () => m.$('as-storeN-value', []), 'unreachable');
    traps(
        'as_unary_operand_0', () => m.$('as-unary-operand', []), 'unreachable');
    traps('as_binary_left_0', () => m.$('as-binary-left', []), 'unreachable');
    traps('as_binary_right_0', () => m.$('as-binary-right', []), 'unreachable');
    traps('as_test_operand_0', () => m.$('as-test-operand', []), 'unreachable');
    traps('as_compare_left_0', () => m.$('as-compare-left', []), 'unreachable');
    traps(
        'as_compare_right_0', () => m.$('as-compare-right', []), 'unreachable');
