...
void main() {
  ...
  group('table_fill.0.wasm', () {
    ...
    returns(
        'fill_0', () => m.$('fill', [2, m.$externref(1), 3]), null /*void*/);
    returns('get_5', () => m.$('get', [1]), null);
    returns('get_6', () => m.$('get', [2]), () => m.$externref(1));
    returns('get_7', () => m.$('get', [3]), () => m.$externref(1));
    returns('get_8', () => m.$('get', [4]), () => m.$externref(1));
    returns('get_9', () => m.$('get', [5]), null);
    returns(
        'fill_1', () => m.$('fill', [4, m.$externref(2), 2]), null /*void*/);
    returns('get_10', () => m.$('get', [3]), () => m.$externref(1));
    returns('get_11', () => m.$('get', [4]), () => m.$externref(2));
    returns('get_12', () => m.$('get', [5]), () => m.$externref(2));
    returns('get_13', () => m.$('get', [6]), null);
    returns(
        'fill_2', () => m.$('fill', [4, m.$externref(3), 0]), null /*void*/);
    returns('get_14', () => m.$('get', [3]), () => m.$externref(1));
    returns('get_15', () => m.$('get', [4]), () => m.$externref(2));
    returns('get_16', () => m.$('get', [5]), () => m.$externref(2));
    returns(
        'fill_3', () => m.$('fill', [8, m.$externref(4), 2]), null /*void*/);
    returns('get_17', () => m.$('get', [7]), null);
    returns('get_18', () => m.$('get', [8]), () => m.$externref(4));
    returns('get_19', () => m.$('get', [9]), () => m.$externref(4));
    returns(
        'fill_abbrev_0', () => m.$('fill-abbrev', [9, null, 1]), null /*void*/);
    returns('get_20', () => m.$('get', [8]), () => m.$externref(4));
    returns('get_21', () => m.$('get', [9]), null);
    returns(
        'fill_4', () => m.$('fill', [0xA, m.$externref(5), 0]), null /*void*/);
    returns('get_22', () => m.$('get', [9]), null);
    traps('fill_5', () => m.$('fill', [8, m.$externref(6), 3]),
        'out of bounds table access');
    returns('get_23', () => m.$('get', [7]), null);
    returns('get_24', () => m.$('get', [8]), () => m.$externref(4));
