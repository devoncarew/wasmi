...
void main() {
  ...
  group('table_fill', () {
    group('table_fill.0.wasm', () {
      ...
      returns(
          'fill_0', () => m.$('fill', [2, $externref(1), 3]), null /*void*/);
      ...
      returns(
          'fill_1', () => m.$('fill', [4, $externref(2), 2]), null /*void*/);
