...
void main() {
  ...
  group('ref_func', () {
    group('ref_func.0.wasm', () {
      ...
      setUpAll(() {
        def =
            ModuleDefinition.parse(File('test/spec/ref_func/ref_func.0.wasm'));
    ...
    group('ref_func.1.wasm', () {
      ...
      setUpAll(() {
        def =
            ModuleDefinition.parse(File('test/spec/ref_func/ref_func.1.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });
    ...
    group('ref_func.3.wasm', () {
      ...
      setUpAll(() {
        def =
            ModuleDefinition.parse(File('test/spec/ref_func/ref_func.3.wasm'));
        m = Module(def, imports: {'spectest': specTestModule(), ...registered});
      });
    });
