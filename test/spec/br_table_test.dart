...
void main() {
  ...
  group('br_table.0.wasm', () {
    ...
    setUpAll(() {
      def = ModuleDefinition.parse(File('test/spec/br_table/br_table.0.wasm'));
    ...
    returns('multiple_value_8', () => m.$('multiple-value', [$i32('FFFFFFFF')]),
        0xD6);
    returns('multiple_value_9', () => m.$('multiple-value', [$i32('FFFFFFFF')]),
        0xD6);
    ...
    returns('as_call_indirect_first_0', () => m.$('as-call_indirect-first', []),
        0x14);
    returns(
        'as_call_indirect_mid_0', () => m.$('as-call_indirect-mid', []), 0x15);
    ...
    returns('nested_block_value_0', () => m.$('nested-block-value', [0]), 0x13);
    returns('nested_block_value_1', () => m.$('nested-block-value', [1]), 0x11);
    returns('nested_block_value_2', () => m.$('nested-block-value', [2]), 0x10);
    returns(
        'nested_block_value_3', () => m.$('nested-block-value', [0xA]), 0x10);
    returns('nested_block_value_4',
        () => m.$('nested-block-value', [$i32('FFFFFFFF')]), 0x10);
    returns('nested_block_value_5', () => m.$('nested-block-value', [0x186A0]),
        0x10);
    ...
    returns('nested_br_value_5', () => m.$('nested-br-value', [$i32('9BD75A')]),
        0x11);
    returns('nested_br_if_value_0', () => m.$('nested-br_if-value', [0]), 0x11);
    ...
    returns(
        'nested_br_if_value_5', () => m.$('nested-br_if-value', [0xF423F]), 8);
    ...
    returns('nested_br_table_value_0', () => m.$('nested-br_table-value', [0]),
        0x11);
    returns(
        'nested_br_table_value_1', () => m.$('nested-br_table-value', [1]), 9);
    returns(
        'nested_br_table_value_2', () => m.$('nested-br_table-value', [2]), 8);
    returns(
        'nested_br_table_value_3', () => m.$('nested-br_table-value', [9]), 8);
  ...
  // assertInvalid('invalid br_table.2.wasm', 'br_table/br_table.2.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.3.wasm', 'br_table/br_table.3.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.4.wasm', 'br_table/br_table.4.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.5.wasm', 'br_table/br_table.5.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.6.wasm', 'br_table/br_table.6.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.7.wasm', 'br_table/br_table.7.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.8.wasm', 'br_table/br_table.8.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.9.wasm', 'br_table/br_table.9.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.10.wasm', 'br_table/br_table.10.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.11.wasm', 'br_table/br_table.11.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.12.wasm', 'br_table/br_table.12.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.13.wasm', 'br_table/br_table.13.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.14.wasm', 'br_table/br_table.14.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.15.wasm', 'br_table/br_table.15.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.16.wasm', 'br_table/br_table.16.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.17.wasm', 'br_table/br_table.17.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.18.wasm', 'br_table/br_table.18.wasm', 'type mismatch');
  // assertInvalid('invalid br_table.19.wasm', 'br_table/br_table.19.wasm', 'unknown label');
  // assertInvalid('invalid br_table.20.wasm', 'br_table/br_table.20.wasm', 'unknown label');
  // assertInvalid('invalid br_table.21.wasm', 'br_table/br_table.21.wasm', 'unknown label');
  // assertInvalid('invalid br_table.22.wasm', 'br_table/br_table.22.wasm', 'unknown label');
  // assertInvalid('invalid br_table.23.wasm', 'br_table/br_table.23.wasm', 'unknown label');
  // assertInvalid('invalid br_table.24.wasm', 'br_table/br_table.24.wasm', 'unknown label');
}
