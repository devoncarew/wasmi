...
void main() {
  ...
  group('br_if', () {
    group('br_if.0.wasm', () {
      ...
      returns(
          'as_block_last_0', () => m.$('as-block-last', [0]), null /*void*/);
      returns(
          'as_block_last_1', () => m.$('as-block-last', [1]), null /*void*/);
      returns('as_block_first_value_0', () => m.$('as-block-first-value', [0]),
          0xB);
      returns('as_block_first_value_1', () => m.$('as-block-first-value', [1]),
          0xA);
      returns(
          'as_block_mid_value_0', () => m.$('as-block-mid-value', [0]), 0x15);
      returns(
          'as_block_mid_value_1', () => m.$('as-block-mid-value', [1]), 0x14);
      returns(
      ...
      returns(
          'as_br_if_value_cond_0', () => m.$('as-br_if-value-cond', [0]), 2);
      returns(
          'as_br_if_value_cond_1', () => m.$('as-br_if-value-cond', [1]), 1);
      ...
      returns('as_call_indirect_first_0',
          () => m.$('as-call_indirect-first', []), 4);
      returns(
          'as_call_indirect_mid_0', () => m.$('as-call_indirect-mid', []), 4);
      returns(
          'as_call_indirect_last_0', () => m.$('as-call_indirect-last', []), 4);
      returns('as_local_set_value_0', () => m.$('as-local.set-value', [0]),
          $i32('FFFFFFFF'));
      returns(
          'as_local_set_value_1', () => m.$('as-local.set-value', [1]), 0x11);
      ...
      returns('as_global_set_value_0', () => m.$('as-global.set-value', [0]),
          $i32('FFFFFFFF'));
      returns(
          'as_global_set_value_1', () => m.$('as-global.set-value', [1]), 1);
      ...
      returns(
          'nested_block_value_0', () => m.$('nested-block-value', [0]), 0x15);
    ...
    // assertInvalid('invalid br_if.1.wasm', 'br_if/br_if.1.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.2.wasm', 'br_if/br_if.2.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.3.wasm', 'br_if/br_if.3.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.4.wasm', 'br_if/br_if.4.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.5.wasm', 'br_if/br_if.5.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.6.wasm', 'br_if/br_if.6.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.7.wasm', 'br_if/br_if.7.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.8.wasm', 'br_if/br_if.8.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.9.wasm', 'br_if/br_if.9.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.10.wasm', 'br_if/br_if.10.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.11.wasm', 'br_if/br_if.11.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.12.wasm', 'br_if/br_if.12.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.13.wasm', 'br_if/br_if.13.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.14.wasm', 'br_if/br_if.14.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.15.wasm', 'br_if/br_if.15.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.16.wasm', 'br_if/br_if.16.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.17.wasm', 'br_if/br_if.17.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.18.wasm', 'br_if/br_if.18.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.19.wasm', 'br_if/br_if.19.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.20.wasm', 'br_if/br_if.20.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.21.wasm', 'br_if/br_if.21.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.22.wasm', 'br_if/br_if.22.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.23.wasm', 'br_if/br_if.23.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.24.wasm', 'br_if/br_if.24.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.25.wasm', 'br_if/br_if.25.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.26.wasm', 'br_if/br_if.26.wasm', 'type mismatch', registered);
    // assertInvalid('invalid br_if.27.wasm', 'br_if/br_if.27.wasm', 'unknown label', registered);
    // assertInvalid('invalid br_if.28.wasm', 'br_if/br_if.28.wasm', 'unknown label', registered);
    // assertInvalid('invalid br_if.29.wasm', 'br_if/br_if.29.wasm', 'unknown label', registered);
  });
}
