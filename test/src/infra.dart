...
import 'package:wasmi/runtime.dart' show Trap;
...
int extern7(int p0, int p1, int p2, int p3, int p4, int p5, int p6) => p0 + p1;
int extern8(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7) =>
    p0 + p1;
int extern9(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7,
        int p8) =>
    p0 + p1;
int extern10(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7,
        int p8, int p9) =>
    p0 + p1;
